# PCA 3 Results visualization
# Matt Kmiecik
# Started 16 SEPTEMBER 2022

# Purpose: to visualize the results from PCA (pca-proc-3.R)

source("r-prep.R")                # Prepares R workspace
load("../output/pca-3-res.RData") # Loads results
...
# uncomment to save out
# ggsave(
#   filename = "../output/pca-3-bsr-plot.svg",
#   plot = bsr_plot,
#   width = 6,
#   height = 5.5,
#   units = "in"
...
# ggsave(
#   filename = "../output/pca-3-partial-etas.svg",
#   plot = peta2_plot,
#   width = 5,
#   height = 4.5,
#   units = "in"
